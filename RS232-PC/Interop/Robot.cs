...
namespace xARMForm
{
    internal class Robot
    {
        ...
        public bool Create(string IP)
        {
            ...
            if (arm == -1)
            {
                arm = XArmAPI.create_instance(IP, false, false, true, true, true, false, true, true, -1, 512, AxisCount, false, "rich", true);
                if (arm != -1)
                {
